                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b flex space-x-2">
                                    <a href="{{ route('clientes.edit', $produto->id) }}" class="bg-green-500 text-black py-1 px-3 rounded-lg shadow-lg hover:shadow-xl transition duration-300 ease-in-out transform hover:scale-105">Editar</a>
                                    <form action="{{ route('clientes.destroy', $produto->id) }}" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir este produto?');">
                                        @csrf
                                        @method('DELETE')
