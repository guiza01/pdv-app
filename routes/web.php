...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/venda/adicionar', [VendaController::class, 'create'])->name('venda.create');
    Route::post('/venda/adicionar', [VendaController::class, 'store'])->name('venda.store');
    Route::put('/venda/{id}', [VendaController::class, 'update'])->name('venda.update');
    Route::get('/venda/{id}/edit', [VendaController::class, 'edit'])->name('venda.edit');
